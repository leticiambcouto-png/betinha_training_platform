...
// ─── Trails ───────────────────────────────────────────────────────────────────
const trailsData = [
  { slug: "tbi-gente-cultura", title: "TBI Gente e Cultura", description: "Trilha de integração sobre a cultura, valores e jeito de trabalhar da Stellar Gaming.", icon: "Star", color: "#00C853", orderIndex: 0 },
...
await insertSlides("orientacoes-gerais", [
  ...
  { orderIndex: 5, title: "Parabéns! Você concluiu o TBI Gente e Cultura!", content: "Você agora conhece a Stellar Gaming de dentro para fora! Valores, história, cultura, estratégia, canais e orientações — você está pronto para começar essa jornada incrível.\n\nBem-vindo ao time!", betinhaSpeech: "PARABÉNS! Você concluiu o TBI Gente e Cultura! Agora você conhece nossa história, nossos valores e nosso jeito de trabalhar. Estou muito orgulhosa de você! Bem-vindo à família Stellar Gaming!", layout: "highlight" },
]);
