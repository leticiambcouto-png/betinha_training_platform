...
// ─── Trails ───────────────────────────────────────────────────────────────────
const trailsData = [
  { slug: "tbi-gente-cultura", title: "Trilha de Onboarding: Gente e Cultura", description: "Trilha de integração sobre a cultura, valores e jeito de trabalhar da Stellar Gaming.", icon: "Star", color: "#00C853", orderIndex: 0 },
...
// ─── Modules ──────────────────────────────────────────────────────────────────
const tbiGCModules = [
  { slug: "institucional", title: "Institucional", subtitle: "Quem Somos", description: "Conheça a Stellar Gaming, nossa missão, visão e o ecossistema que estamos construindo.", orderIndex: 0, pointsReward: 150, bonusPoints: 75, deadlineDays: 1, isComingSoon: 0 },
  ...
  { slug: "falando-de-negocio", title: "Falando de Negócio", subtitle: "Mercado iGaming", description: "Entenda o mercado de iGaming, Sportsbook e Cassino onde a Stellar Gaming atua.", orderIndex: 4, pointsReward: 150, bonusPoints: 75, deadlineDays: 1, isComingSoon: 0 },
  { slug: "organograma", title: "Organograma", subtitle: "Nossa Estrutura", description: "Conheça a estrutura organizacional da Stellar Gaming e a área de Gente e Cultura.", orderIndex: 5, pointsReward: 100, bonusPoints: 50, deadlineDays: 2, isComingSoon: 0 },
...
await insertSlides("institucional", [
  { orderIndex: 0, title: "Bem-vindo à Stellar Gaming!", content: "Que incrível ter você aqui! Hoje começa uma nova jornada — e eu, Betinha, vou ser sua guia nessa aventura. Prepare-se para conhecer tudo sobre a Stellar Gaming, nossa cultura e nosso jeito único de trabalhar.", betinhaSpeech: "Oi! Eu sou a Betinha, e estou super animada para te receber na Stellar Gaming! Você faz parte agora de um time incrível. Vamos juntos nessa jornada?", layout: "highlight" },
  { orderIndex: 1, title: "Quem é a Stellar Gaming?", content: "A Stellar Gaming é uma holding do setor de GamingTech que desenvolve e integra tecnologia para operações de iGaming. Operamos as marcas EstrelaBet e Vupi. Somos muito mais do que uma casa de apostas — somos um ecossistema completo.", betinhaSpeech: "A Stellar Gaming é uma holding que une tecnologia de ponta, dados inteligentes e entretenimento responsável. Somos um ecossistema, não apenas uma empresa!", layout: "default" },
...
await insertSlides("nossa-historia", [
  ...
  { orderIndex: 6, title: "2025 — Stellar Gaming", content: "Recebemos a licença definitiva para operar no Brasil. Integramos a marca VUPI ao nosso portfólio. Nos apresentamos ao mercado como Stellar Gaming — uma holding que une forças para transformar o entretenimento digital.", betinhaSpeech: "E chegamos a 2025 como Stellar Gaming! Com licença definitiva, a VUPI no time e um futuro brilhante pela frente. E você faz parte dessa nova fase!", layout: "highlight" },
...
await insertSlides("falando-de-negocio", [
  { orderIndex: 0, title: "O Mercado iGaming", content: "O iGaming é a indústria de jogos de apostas online. Ela reúne diversas modalidades de entretenimento digital, como cassinos virtuais, poker, bingo, roleta, blackjack e muito mais. É o mercado no qual a Stellar Gaming atua.", betinhaSpeech: "Bem-vindo ao mundo do iGaming! É um mercado gigante, cheio de inovação e tecnologia. E a Stellar Gaming está na vanguarda de tudo isso.", layout: "highlight" },
...
await insertSlides("planejamento-estrategico", [
  { orderIndex: 0, title: "Planejamento feito. Direção traçada.", content: "O plano dos próximos 5 anos está em curso e você faz parte dele. A Stellar Gaming tem uma visão clara de onde quer chegar e como vai chegar lá.", betinhaSpeech: "O plano está feito, a direção está traçada. E o mais importante: você faz parte desse plano! Vamos ver onde estamos indo juntos?", layout: "highlight" },
...
await insertSlides("nossos-rituais", [
  { orderIndex: 0, title: "Reconhecer e celebrar faz parte do nosso jogo!", content: "Na Stellar Gaming, temos rituais corporativos que nos mantêm alinhados, conectados e celebrando as conquistas juntos. Esses momentos são fundamentais para nossa cultura.", betinhaSpeech: "Rituais não são burocracia — são os momentos que nos conectam como time! Vamos conhecer os rituais que fazem a Stellar Gaming ser especial.", layout: "highlight" },
...
await insertSlides("orientacoes-gerais", [
  ...
  { orderIndex: 5, title: "Parabéns! Você concluiu o Trilha de Onboarding: Gente e Cultura!", content: "Você agora conhece a Stellar Gaming de dentro para fora! Valores, história, cultura, estratégia, canais e orientações — você está pronto para começar essa jornada incrível.\n\nBem-vindo ao time!", betinhaSpeech: "PARABÉNS! Você concluiu o Trilha de Onboarding: Gente e Cultura! Agora você conhece nossa história, nossos valores e nosso jeito de trabalhar. Estou muito orgulhosa de você! Bem-vindo à família Stellar Gaming!", layout: "highlight" },
]);
