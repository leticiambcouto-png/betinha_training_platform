          ...
          >
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="relative">
                  <Avatar className="w-14 h-14 border-2 border-gray-400">
                    <AvatarFallback className="bg-gray-400/20 text-gray-300 font-bold">
                ...
                <div className="bg-gray-400/20 border border-gray-400/40 rounded-xl px-3 py-4 text-center w-20">
                  <p className="text-xs text-gray-400 font-bold">2º</p>
            ...
            {top3[0] && (
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="relative">
                  <Avatar className="w-20 h-20 border-2 border-yellow-400 stellar-glow">
                    <AvatarFallback className="bg-yellow-400/20 text-yellow-300 font-bold text-xl">
                ...
                <div className="bg-yellow-400/20 border border-yellow-400/40 rounded-xl px-4 py-5 text-center w-24">
                  <p className="text-xs text-yellow-400 font-bold">1º</p>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="relative">
                  <Avatar className="w-14 h-14 border-2 border-orange-400">
                    <AvatarFallback className="bg-orange-400/20 text-orange-300 font-bold">
                ...
                <div className="bg-orange-400/20 border border-orange-400/40 rounded-xl px-3 py-3 text-center w-20">
                  <p className="text-xs text-orange-400 font-bold">3º</p>
